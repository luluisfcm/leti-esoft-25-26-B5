...
![US21-SD-RestAPI-READ](svg/US21-SD-RestAPI-READ.svg)

### 4.3. UPDATE operation

![US21-SD-RestAPI-UPDATE](svg/US21-SD-RestAPI-UPDATE.svg)

### 4.4. DELETE operation

![US21-SD-RestAPI-DELETE](svg/US21-SD-RestAPI-DELETE.svg)
